...
class MockStackFrame1 implements ValueStackFrame {
    ...
    function functionName() { return 'aFunction'; }

    function className() { return 'DummyClass1'; }
...
class MockStaticVariable1 implements ValueStaticVariable, ValueImpl {
    ...
    function functionName() { return 'blahFunction'; }
...
class MockStaticVariable2 implements ValueStaticVariable, ValueImpl {
    ...
    function functionName() { return 'blahMethod'; }
